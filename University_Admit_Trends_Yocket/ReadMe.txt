...
Thus, this small application gathers the data from the Yocket website and visualize some trends that the universities tend to possess in Accepting or Rejecting a candidate by using Python libraries such as BeautifulSoup, Pandas, Matplotlib, etc.
